...
func (h *GrpcHandler) CheckUserExists(ctx context.Context, req *pb.CheckUserRequest) (*pb.CheckExistenceResponse, error) {
	exists, err := h.service.UserExists(ctx, req.Id)
	if err != nil {
		return nil, h.mapError(err)
	}
